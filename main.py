...
EXCLUDED_CHANNEL_IDS = [
    ...
    1399357598352019548,  # 번역 제외할 채널 가입작성-joing-chat
    1400027887658209351,  # 번역 제외할 채널 event-notice
    1399366102915747912,  # 번역 제외할 채널 share-picture
    1400036681226391592   # 번역 제외할 채널 가입환영
]
